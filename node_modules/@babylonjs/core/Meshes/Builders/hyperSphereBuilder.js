 ...
 */
export function CreateHyperSphereVertexData(options) {
 ...
 */
export function CreateHyperSphere(name, options = {}, scene = null) {
    const sphere = new Mesh(name, scene);
    options.sideOrientation = Mesh._GetDefaultSideOrientation(options.sideOrientation);
    sphere._originalBuilderSideOrientation = options.sideOrientation;
    const vertexData = CreateHyperSphereVertexData(options);
 ...
 */
export const HyperSphereBuilder = {
    // eslint-disable-next-line @typescript-eslint/naming-convention
    CreateHyperSphere,
};
VertexData.CreateHyperSphere = CreateHyperSphereVertexData;
Mesh.CreateHyperSphere = (name, segments, diameter, time, scene, updatable, sideOrientation) => {
    const options = {
        segments: segments,
        diameterX: diameter,
        diameterY: diameter,
